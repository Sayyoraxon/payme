...
import { onlineServicesru } from "../data//onlineServices"
...
const OnlineServices = ({ home, payment, setInput1, setInput2, setImage, setLogoname, setServicetype, setNumber }) => {
    const mobile_operators = payment && payment.types[7]
    const utilities = home.APRIL === "Aprel" ? onlineServices.result.merchants : onlineServicesru.result.merchants 
