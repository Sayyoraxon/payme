...
const Edu = ({ home, payment, setInput1, setInput2, setImage, setLogoname, setServicetype, setNumber }) => {
    const mobile_operators = payment && payment.types[13]
    const utilities = home.APRIL === "Aprel" ? edu.result.merchants : eduru.result.merchants
