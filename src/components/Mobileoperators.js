...
const Mobile_operators = ({ home, payment, setInput1, setInput2, setImage, setLogoname  }) => {
            ...
            <Grid container className='padding' sx={{ "@media (max-width: 1139px)": { px: "60px", py: 0 }, "@media (min-width: 1140px)": { width: "1140px", mr: "auto", ml: "auto" } }}>
                ...
                <Grid item md={12} sm={12} xs={12} sx={{ mt: 3, pb: 3, overflow: "hidden" }} height={!hide ? "178px" : "auto"} >
                    <Grid container spacing={3} >
                        ...
                        <Grid item onClick={() => {
                            setOpen(true)
                            setLogomo(uzmobile_cdma)
                            setNamemo("UzMobile CDMA")
                        }}>
                            <Card className="card"
                                sx={{ width: "106px", height: "60px", px: 6, py: 7 }}>
                                <CardMedia
                        ...
                        <Grid item onClick={() => {
                            ...
                            <Card className="card"
                                sx={{ width: "106px", height: "52px", px: 6, py: 7.5 }}>
                                <CardMedia
                                    component="img"
                                    image={mobiuz}
                                    title="UMS" />
                        ...
                        <Grid item onClick={() => {
                            setOpen(true)
                            setLogomo(uzmobile_gsm)
                            setNamemo("Uzmobile gsm")
                        }}>
                            <Card className="card"
                                sx={{ width: "106px", height: "60px", px: 6, py: 7 }}>
                                <CardMedia
