...
import { bankkredit } from "../data/bankkredit"
import { bankkreditru } from "../data/bankkredit"
...
const Kredit = ({ home, payment, setInput1, setInput2, setImage, setLogoname, setServicetype, setNumber }) => {
    const mobile_operators = payment && payment.types[10]
    const utilities = home.APRIL === "Aprel" ? bankkredit.result.merchants : bankkreditru.result.merchants
                        ...
                        {prefix.map((item) => (
                            <>
                                {item.values
                                    ...
                                    :
                                    item.name === "Phone" || item.name === "Telefon"
                                        ?
                                        <Grid item sx={{ mr: "auto", ml: "auto", mb: 1 }}>
